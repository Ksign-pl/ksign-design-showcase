...
Użycie:  python ebook/rabat-zjada-zysk/pdf_kompresja.py export/ebook/ebook.pdf [--jakosc 84] [--skala 0.62]
    ...
    doc.set_metadata(
        {
            **meta,
            ...
            "subject": meta.get("subject") or "Black Friday w sklepie, na marketplace i w salonie bez utraty marży",
            "keywords": meta.get("keywords") or "Black Friday, rabat, marża, Omnibus, najniższa cena z 30 dni, KSIGN",
        }
    )
