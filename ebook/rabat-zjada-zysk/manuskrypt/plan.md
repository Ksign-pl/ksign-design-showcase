...
| Pole               | Wartość                                                                                                                                                                         |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Numer w serii      | 02 (pierwszy e-book serii to „Nie ma cię w rozmowie.”)                                                                                                                          |
| Tytuł              | Rabat zjada zysk.                                                                                                                                                               |
| Podtytuł           | Black Friday w sklepie, na marketplace i w salonie bez utraty marży                                                                                                             |
| Filar              | 05 · E-commerce omnichannel                                                                                                                                                     |
| Dla kogo           | Sklepy przygotowujące Black Friday w kilku kanałach sprzedaży (segment: średnie i duże sklepy)                                                                                  |
| Problem czytelnika | Na Black Friday rabaty są wszędzie, sprzedaż rośnie, a zysk spada. Każdy kanał ma inne ceny i zasady, a zespół gubi się w wyjątkach.                                            |
| Obietnica          | W 20 minut ustalisz, jaki rabat możesz dać na każdy produkt, jak pokazać go zgodnie z prawem w każdym kanale i co dać klientom zamiast rabatu tam, gdzie się nie opłaca.        |
| Premiera           | **[DO DECYZJI]** Propozycja: czwartek 8.10.2026, najpóźniej 14.10. Black Friday jest 27.11.2026, a obniżki od 28.10 wpływają już na procent, który sklep pokaże w Black Friday. |
...
Z kalendarza w raporcie: „Kampanie Google i Meta Ads, newsletter na Q4”. Układ jak w e-booku #01: bezpłatny pierwszy
krok, potem usługi.

1. **Przegląd cen Black Friday · 0 zł.** Sprawdzimy 10 Twoich produktów w każdym kanale: najniższą cenę z 30 dni,
   sposób pokazania obniżki i reklamy produktowe. **[DO DECYZJI: nazwa, termin odpowiedzi]**
2. **Kampanie na Q4 · Google i Meta Ads.** Od października do Cyber Monday, z budżetem liczonym od marży z kalkulatora,
   a nie od przychodu. **[DO DECYZJI: cena lub „wycena po przeglądzie”]**
3. **Newsletter na Q4.** Zapisy z wczesnym dostępem przed Black Friday, kampania w tygodniu Black Friday i drugi zakup
   w grudniu bez rabatu. **[DO DECYZJI: cena]**

**Dodatek do rozważenia:** kalkulator z rozdziału 02 jako arkusz Google Sheets do skopiowania (link w e-booku). Logika
jest już w `kalkulator.mjs`. Moja rekomendacja: tak – arkusz ludzie zapisują i udostępniają dalej, więc e-book dłużej
pracuje.

## Badanie – propozycja (rozdział 08 i publikacja w grudniu)

- **Pytania:**
  1. Czy przy obniżce jest najniższa cena z 30 dni?
  2. Czy procent liczony jest od niej?
  3. Czy ceny rosną w październiku, przed oknem 30 dni?
  4. Jak głęboki jest rabat w Black Friday względem najniższej ceny z 30 dni?
- **Próba:** 100 sklepów z badania do e-booka #01 (`ebook/chatgpt-ads/badanie/proba_100.csv`, 8 kategorii), po ok.
  10 produktów – razem ok. 1000. 24 sklepy z tej próby blokowały automaty, więc trzeba je zastąpić innymi z listy
  kandydatów albo odczytywać ręcznie.
- **Metoda:** raz dziennie odczyt ceny i informacji o obniżce z karty produktu, 1 zapytanie na produkt na dobę,
  zgodnie z robots.txt. Termin: 1.10–7.12.2026 (Black Friday, Cyber Monday i tydzień po).
- **Publikacja:**
  - w e-booku pierwsze wyniki z października;
  - w grudniu pełne wyniki (w kalendarzu: „Gru 2026 – wyniki badania cen”);
  - bez nazw pojedynczych sklepów, tylko zbiorczo.
- **[DO DECYZJI przed 1.10]:** gdzie uruchomić codzienny odczyt (GitHub Actions w tym repo albo serwer KSIGN) i czy
  w ogóle robimy badanie w tym terminie. Bez decyzji do ok. 5.10 zostaje tylko jednorazowy przegląd, bez historii cen.

## Haki na Instagram i YouTube

| Format           | Hak                                                               | Materiał z e-booka              |
| ---------------- | ----------------------------------------------------------------- | ------------------------------- |
| Rolka / Short    | „Rabat 20% nie zabiera 20% zysku. Zabiera połowę.”                | str. 5–6, tabela z fotelem      |
| Rolka / Short    | „−30%? Według prawa to −12,5%.”                                   | str. 16, Black Week → BF        |
| Rolka / Short    | „Promocja na Halloween zepsuje Ci Black Friday.”                  | str. 16, okres 28.10–26.11      |
| Karuzela         | „Tabela, którą powiesisz nad biurkiem przed Black Friday”         | str. 10, tabela progu           |
| Karuzela         | „5 błędów z decyzji UOKiK wobec Zalando i Temu (nieprawomocnych)” | str. 19                         |
| YouTube 8–10 min | „Black Friday bez straty: policz rabat w 3 minuty”                | rozdziały 01–02, kalkulator A–J |

Miniatura YouTube: „−20% = −50% zysku” na tle metki z odgryzionym rogiem.

## Do sprawdzenia tuż przed publikacją

- **Allegro:** daty i warunki Black Weeks 2026 w Pomocy Allegro dla sprzedających (str. 22 i 29). Potwierdzone są
  tylko zasady z 2025 r.: 31.10–1.12, min. 5% obniżki, bez dodatkowej prowizji.
- **UOKiK:** czy wyszła nowsza wersja wyjaśnień o obniżkach (obecna z 2023 r.) i jaki jest stan 6 postępowań
  z komunikatu z 12.01.2026 (str. 19).
- **Gemius:** czy wyszedł raport „E-commerce w Polsce 2026”. Jeśli tak – podmienić dane ze str. 25 i 27.
- **Koszt reklam w listopadzie:** podajemy tylko z danych kont KSIGN albo ze źródła z liczbami. Bez ogólników w stylu
  „CPM rośnie o X%”.
