...
// Użycie: node ebook/chatgpt-ads/zloz.mjs && node ebook/chatgpt-ads/tekst.mjs
...
try {
  ...
  const md = [
    "# NIE MA CIĘ W ROZMOWIE – tekst finalny v1.0 (1:1 ze składem)",
    "",
    ...
    "> Źródła i notatki redakcyjne: `rozdzialy-01-02.md`, `rozdzialy-03-08.md`.",
    "",
