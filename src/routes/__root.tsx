...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "KSING — Premium Websites & AI Systems" },
      ...
      { property: "og:title", content: "KSING — Premium Websites & AI Systems" },
      ...
      { name: "twitter:title", content: "KSING — Premium Websites & AI Systems" },
