...
export const Route = createFileRoute("/sitemap")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Pełna mapa witryny KSIGN: strona główna, sekcje (manifest, pakiet, proces, cennik, FAQ, kontakt) oraz dokumenty prawne." },
      { property: "og:title", content: "Mapa witryny — KSIGN" },
      { property: "og:description", content: "Pełna mapa witryny KSIGN: strona główna, sekcje oraz dokumenty prawne." },
