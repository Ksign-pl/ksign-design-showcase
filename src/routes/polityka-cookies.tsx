  ...
  head: () => ({
    meta: [
      { title: "Polityka cookies — KSIGN" },
      {
        name: "description",
        content:
          "Informacje o plikach cookies używanych przez KSIGN — rodzaje, cele i zarządzanie zgodami.",
      },
      { name: "robots", content: "noindex, follow" },
      { property: "og:title", content: "Polityka cookies — KSIGN" },
      {
        property: "og:description",
        content: "Informacje o plikach cookies i ustawieniach zgód na stronie KSIGN.",
      },
        ...
        children: JSON.stringify({
          ...
          itemListElement: [
            { "@type": "ListItem", position: 1, name: "Strona główna", item: "https://ksign.pl/" },
            {
              ...
              item: "https://ksign.pl/polityka-cookies",
            },
          ],
        }),
      },
        ...
        <div className="mt-10 space-y-8 text-ink/80 leading-relaxed">
          <Section title="1. Czym są pliki cookies">
            <p>
              ...
              korzystania ze strony. Pozwalają one m.in. zapamiętać Twoje preferencje, mierzyć ruch
              i dopasowywać treści.
            </p>
          </Section>

          <Section title="2. Podstawa prawna">
            <p>
              Wykorzystanie cookies innych niż niezbędne wymaga Twojej zgody — zgodnie z art. 173
              ustawy Prawo telekomunikacyjne oraz art. 6 ust. 1 lit. a RODO. Zgodę możesz w każdej
              chwili wycofać.
            </p>
          </Section>
          ...
          <Section title="3. Kategorie cookies">
            <div className="space-y-4">
              <Cat name="Niezbędne" required>
                Wymagane do podstawowego działania strony (sesja, bezpieczeństwo, zapamiętanie
                wyboru zgód). Nie wymagają zgody.
                <br />
                <em>Przykłady: ksign_consent_v1 (12 miesięcy).</em>
              </Cat>
              <Cat name="Analityczne">
                Pozwalają anonimowo mierzyć ruch i ulepszać stronę.
                <br />
                <em>
                  Dostawca: Google LLC — Google Analytics 4 (cookies _ga, _ga_*; do 24 miesięcy).
                </em>
              </Cat>
              <Cat name="Marketingowe">
                ...
                <br />
                <em>
                  Dostawca: Meta Platforms Ireland Ltd. — Meta Pixel (cookies _fbp, fr; do 90 dni).
                </em>
              </Cat>
            </div>
          </Section>
          ...
          <Section title="4. Przekazywanie danych poza EOG">
            <p>
              Dostawcy zewnętrzni (Google, Meta) mogą przetwarzać dane w państwach trzecich w
              oparciu o standardowe klauzule umowne i ramy Data Privacy Framework.
            </p>
          </Section>

          <Section title="5. Zarządzanie cookies">
            <p>
              W każdej chwili możesz zmienić swoje preferencje, klikając „Zarządzaj zgodami" powyżej
              lub w stopce strony. Możesz również usunąć/zablokować cookies w ustawieniach
              przeglądarki — może to jednak wpłynąć na działanie niektórych funkcji.
            </p>
          </Section>
  ...
  return (
    <div className="rounded-2xl border border-ink/10 p-5 bg-white/40">
      <div className="flex items-center gap-2 mb-2">
        ...
        {required && (
          <span className="text-[10px] font-mono uppercase tracking-widest bg-ink text-cream px-2 py-0.5 rounded-full">
            Wymagane
          </span>
        )}
      </div>
